...
import { ShapeButton } from "../Engine/UIComponent/ShapeButton";
...
export default class  MainScene extends BasicNode {
    ...
    private onSpriteOneFourFourPressed(_event: Event) {
        ...
        this.topChild  = new SpriteOneFourFour(game.loader.resources[Assets.getInstance().getRelativePath("spriteOneFourFour")]?.data.spriteOneFourFour);
    ...
    private onMixedTextPressed(_event: Event) {
        game.stage.removeChild(this);
        this.topChild  = new MixedText(game.loader.resources[Assets.getInstance().getRelativePath("mixedText")]?.data.mixedText);
        game.stage.addChild(this.topChild);
    }
